...
<tr><td>carbide_bmc_proxy_cache_refreshes_total</td><td>counter</td><td>Number of upstream fetches the response cache issued for misses and refreshes, by request class and result (stored, revalidated, uncacheable, failed)</td></tr>
