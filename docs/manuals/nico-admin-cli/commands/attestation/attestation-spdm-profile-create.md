...
*[Hardware commands](../../hardware.md) › [attestation](./attestation.md) › [spdm](./attestation-spdm.md) › [profile](./attestation-spdm-profile.md) › **create***
...
Which attesters the hardware requires. allowlist and denylist take at
least one --exact or --prefix between them; all and none take neither
...
>
> - denylist: Attest every attester the BMC reports except those a
>   pattern matches
...
```sh
nico-admin-cli attestation spdm profile create nvidia_dgx-gb200 --mode allowlist --prefix HGX_IRoT_GPU_
nico-admin-cli attestation spdm profile create nvidia_dgx-gb200 --mode allowlist --prefix HGX_IRoT_GPU_ --exact VERA_CPU_0
