...
*[Hardware commands](../../hardware.md) › [attestation](./attestation.md) › [spdm](./attestation-spdm.md) › [profile](./attestation-spdm-profile.md) › **delete***
...
```sh
nico-admin-cli attestation spdm profile delete nvidia_dgx-gb200 --if-version-match V7-T1789080000000000
