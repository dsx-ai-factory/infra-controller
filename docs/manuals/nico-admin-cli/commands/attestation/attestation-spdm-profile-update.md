...
*[Hardware commands](../../hardware.md) › [attestation](./attestation.md) › [spdm](./attestation-spdm.md) › [profile](./attestation-spdm-profile.md) › **update***
...
```sh
nico-admin-cli attestation spdm profile update nvidia_dgx-gb200 --mode denylist --exact HGX_BMC_0 --if-version-match V7-T1789080000000000
