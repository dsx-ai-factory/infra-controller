...
Infrastructure Provider callers receive keys from their Provider's Machines. Tenant Admin callers receive keys only from Sites where `TargetedInstanceCreation` is effective. The optional siteId parameter further restricts the result.
...
Infrastructure Provider callers receive values from their Provider's Machines. Tenant Admin callers receive values only from Sites where `TargetedInstanceCreation` is effective. The optional siteId parameter further restricts the result.
