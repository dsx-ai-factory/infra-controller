...
type ApiCreateOrUpdateRackHealthReportRequest struct {
	ctx                          context.Context
	ApiService                   *RackAPIService
	org                          string
	id                           string
	rackHealthReportEntryRequest *RackHealthReportEntryRequest
}

func (r ApiCreateOrUpdateRackHealthReportRequest) RackHealthReportEntryRequest(rackHealthReportEntryRequest RackHealthReportEntryRequest) ApiCreateOrUpdateRackHealthReportRequest {
	r.rackHealthReportEntryRequest = &rackHealthReportEntryRequest
	return r
}

func (r ApiCreateOrUpdateRackHealthReportRequest) Execute() (*MachineHealthReportEntry, *http.Response, error) {
	return r.ApiService.CreateOrUpdateRackHealthReportExecute(r)
}

/*
CreateOrUpdateRackHealthReport Create or update Rack health report

Add or update a health report override for a specific Rack.
...
Org must have an Infrastructure Provider entity that owns the Site. User must have authorization role with `PROVIDER_ADMIN` suffix.
	...
	@param org Name of the Org
	@param id ID of the Rack
	@return ApiCreateOrUpdateRackHealthReportRequest
*/
func (a *RackAPIService) CreateOrUpdateRackHealthReport(ctx context.Context, org string, id string) ApiCreateOrUpdateRackHealthReportRequest {
	return ApiCreateOrUpdateRackHealthReportRequest{
		ApiService: a,
		ctx:        ctx,
		org:        org,
...
func (a *RackAPIService) CreateOrUpdateRackHealthReportExecute(r ApiCreateOrUpdateRackHealthReportRequest) (*MachineHealthReportEntry, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RackAPIService.CreateOrUpdateRackHealthReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/org/{org}/nico/rack/{id}/health-report"
	localVarPath = strings.Replace(localVarPath, "{"+"org"+"}", url.PathEscape(parameterValueToString(r.org, "org")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.rackHealthReportEntryRequest == nil {
		return localVarReturnValue, nil, reportError("rackHealthReportEntryRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.rackHealthReportEntryRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiDeleteRackHealthReportRequest struct {
	ctx        context.Context
	ApiService *RackAPIService
	siteId     *string
	org        string
...
func (r ApiDeleteRackHealthReportRequest) SiteId(siteId string) ApiDeleteRackHealthReportRequest {
	r.siteId = &siteId
	return r
}

func (r ApiDeleteRackHealthReportRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteRackHealthReportExecute(r)
}

/*
DeleteRackHealthReport Delete Rack health report

Remove a health report override for a specific Rack.
...
Org must have an Infrastructure Provider entity that owns the Site. User must have authorization role with `PROVIDER_ADMIN` suffix.
	...
	@return ApiDeleteRackHealthReportRequest
*/
func (a *RackAPIService) DeleteRackHealthReport(ctx context.Context, org string, id string, source string) ApiDeleteRackHealthReportRequest {
	return ApiDeleteRackHealthReportRequest{
		ApiService: a,
		ctx:        ctx,
		org:        org,
...
// Execute executes the request
func (a *RackAPIService) DeleteRackHealthReportExecute(r ApiDeleteRackHealthReportRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RackAPIService.DeleteRackHealthReport")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/org/{org}/nico/rack/{id}/health-report/{source}"
	localVarPath = strings.Replace(localVarPath, "{"+"org"+"}", url.PathEscape(parameterValueToString(r.org, "org")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetAllRackHealthReportRequest struct {
	ctx        context.Context
	ApiService *RackAPIService
	siteId     *string
	org        string
...
// ID of the Site that owns the Rack
func (r ApiGetAllRackHealthReportRequest) SiteId(siteId string) ApiGetAllRackHealthReportRequest {
	r.siteId = &siteId
	return r
}

func (r ApiGetAllRackHealthReportRequest) Execute() ([]MachineHealthReportEntry, *http.Response, error) {
	return r.ApiService.GetAllRackHealthReportExecute(r)
}

/*
GetAllRackHealthReport Retrieve all Rack health reports

Get all health report overrides for a specific Rack.
...
Org must have an Infrastructure Provider entity that owns the Site. User must have authorization role with `PROVIDER_ADMIN` suffix.
	...
	@param org Name of the Org
	@param id ID of the Rack
	@return ApiGetAllRackHealthReportRequest
*/
func (a *RackAPIService) GetAllRackHealthReport(ctx context.Context, org string, id string) ApiGetAllRackHealthReportRequest {
	return ApiGetAllRackHealthReportRequest{
		ApiService: a,
		ctx:        ctx,
		org:        org,
...
//
//	@return []MachineHealthReportEntry
func (a *RackAPIService) GetAllRackHealthReportExecute(r ApiGetAllRackHealthReportRequest) ([]MachineHealthReportEntry, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RackAPIService.GetAllRackHealthReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
