...
- `observed_at` attribute on Machine health was deprecated in favor of `observedAt` and will be removed on **September 10th, 2026 0:00 UTC**. Please use `observedAt` instead.
