...
///
/// The variants mirror the parameters of [`ApiClient::add_expected_machine`],
/// [`ApiClient::add_expected_switch`], and
/// [`ApiClient::add_expected_power_shelf`] so a record can be retried without
