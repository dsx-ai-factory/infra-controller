...
/// Verifies a whole-definition data update accepts unchanged service interface
/// requirements and remains queued for service VPC reconciliation.
#[crate::sqlx_test]
...
/// Verifies a registration may replace its complete interface requirements
/// when no durable instance attachment can depend on the old definition.
#[crate::sqlx_test]
