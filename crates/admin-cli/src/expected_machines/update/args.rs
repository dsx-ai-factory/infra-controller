...
credentials and a serial containing 4-64 ASCII letters, digits, hyphens, or underscores.
...
`disable_lockdown` explicitly to `true` or `false`. An empty object preserves the setting with PATCH
